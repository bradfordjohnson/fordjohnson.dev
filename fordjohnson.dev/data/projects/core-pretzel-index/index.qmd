---
pagetitle: "The Core Pretzel Index: A Pretzel Ranking System"
description-meta: The Core Pretzel Index (CPI) is a data-driven ranking system for restaurant pretzels. Explore ratings based on texture, flavor, freshness, and dipping sauce to find the best pretzels.
toc: true
toc-depth: 4
toc-expand: true
html-math-method:
...
| Restaurant | Visit Number | Base CPI Score | Decay Weight | Weighted Score |
|------------|--------------|----------------|--------------|----------------|
| X          | 1            | 80%          | 0.05         | 3.98%          |
| X          | 2            | 90%          | 0.14         | 12.18%         |
| X          | 3            | 80%          | 0.37         | 29.43%         |
...
$$
\text{Decay Adjusted Score} = \frac{\sum_{i=1}^{n} (\text{Base CPI Score}_i \times \text{Decay Weight}_i)}{\sum_{i=1}^{n} \text{Decay Weight}_i}
$$
...
| Date       | Restaurant | Pretzel Type | Visit Number | Menu Price | Base CPI Score |
|------------|------------|--------------|--------------|------------|----------------|
| 2025-03-22 | Holy City  | Salt         | 1            | $6.50      | 79.00%         |
